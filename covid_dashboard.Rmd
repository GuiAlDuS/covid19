...
g_sexo <- ggplot(sexo, 
  ...
  geom_col_interactive(
    aes(tooltip = paste0(
      ...
      data_id = ID),
    position = position_dodge()) +
  scale_fill_branded_d(primary = "grey",
                       other = "orange") +
  scale_y_continuous(limits = c(0, NA),
                     expand = c(0,2)) +
  scale_x_date(date_breaks = "1 week", 
...
girafe(ggobj = plot_grid(alineados[[1]], alineados[[2]], alineados[[3]], ncol = 1),
       options = list(
...
Elaborado por gds506@gmail.com con datos diarios del [CSSE del John Hopkins University](https://github.com/CSSEGISandData/COVID-19) y del Ministerio de Salud de Costa Rica. 
