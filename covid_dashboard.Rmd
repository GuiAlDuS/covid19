...
### Evolución de casos por cantón durante los últimos 30 días
...
cant_heatmap <- cant_heatmap[
  ...
  fecha >= lubridate::ymd(fecha_hoy) - days(30)
]
...
g_cant_2_g <- g_cant_2 + 
  geom_tile_interactive(
    aes(tooltip = paste0(
      ...
      day(fecha), " de ", month(fecha, label=TRUE, abbr=FALSE), "\n",
      positivos," casos totales", "\n",
      nuevos_positivos," casos positivos nuevos", "\n",
      nuevos_activos, " casos activos nuevos"),
      data_id = ID), 
    width=.9, height=.8)
